...
<div class="py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="">Upload RPS&nbsp;<span class="badge badge-primary">{{ Auth::user()->code }}</span></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" width:1%; white-space:nowrap;">
                                    <form action="/upload/rpsfile" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
